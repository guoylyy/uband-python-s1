...
# 做几件事情
# 1. 把老爸换成老妈，做的时候数一数改了几处代码  A：7处
# 2. 把撕毁的页码换成'abase'，做的时候数一数改了几处代码 A：2处
# 3. 想想如何让最后粘贴回 撕毁代码页 的时候不用重复再打一遍长串释意 A:添加临时变量  value_abase=book['abase']
