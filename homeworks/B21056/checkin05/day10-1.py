...
# 做几件事情
# 1. 把老爸换成老妈，做的时候数一数改了几处代码---------------------共7处
# 2. 把撕毁的页码换成'abase'，做的时候数一数改了几处代码------------共4处
...
def homework2():
  ...
  if not book.has_key('etiquette'): #没有查到
    ...
    if book.has_key('abase'):
      ...
      #老爸黏贴了代码
      #book['abase'] = 'to give up to the control or influence of another person or agent'
      book['abase'] = dustbin#------------------第3题
